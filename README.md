...
3X-UI или Hysteria2, собрать каскад через российский сервер и направить
трафик через прокси прямо на роутере Keenetic с XKeen. Каждая инструкция —
...
- Для 3X-UI Pro — **два домена или сабдомена**, направленных на IP сервера
  (для «4 инбаундов» и каскада домены не нужны)
