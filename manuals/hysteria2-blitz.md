...
2. Создайте пользователя кнопкой **+** — с лимитом трафика и сроком, если нужно.
   Если в списке есть пользователь по умолчанию, отметьте его и удалите красной кнопкой.
3. Значок QR в колонке **Configs** покажет QR-код и ссылку `hy2://` —
   отправьте её в клиент: Hiddify, v2rayN, Streisand, NekoBox.
