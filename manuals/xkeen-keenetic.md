...
В веб-интерфейсе роутера: **Общие настройки → Изменить набор компонентов**.
...
Пропишите шифрованные DNS-серверы (DoT или DoH) в **Интернет → DNS**,
иначе выборочная маршрутизация будет работать неправильно.
...
Устройства, которые должны ходить через прокси, добавьте в политику доступа
**XKeen** в разделе **Приоритеты подключений**.
