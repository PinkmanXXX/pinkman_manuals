...
В панели **российского** сервера: **Настройки Xray → Исходящие подключения → Создать исходящее подключение**.
...
> [!TIP]
> Быстрее: на вкладке **JSON** вставьте ссылку `vless://` в поле **Ссылка**
> и нажмите значок справа от него — панель заполнит поля сама. Проверьте
> только **Тег**.
...
Нажмите **Сохранить**, затем **Перезапуск Xray** вверху страницы.
